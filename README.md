...
- Ensure that the credentials provided to the RDP client are for a configured user on the instance as opposed to a domain user. You may have to enter "\Administrator" instead of just "Adminstrator" to get it stop trying to use a domain user. 
